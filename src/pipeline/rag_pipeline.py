...
class RAGPipeline:
    ...
    Usage:
        ...
        # Index SEC filings with section extraction
        pipeline.ingest_file("10k.txt", use_sections=True)
    ...
    def ingest_file(
        ...
        Args:
            ...
            use_sections: Extract sections for supported files (e.g., SEC filings)
        ...
        # Load document(s)
        documents = LoaderFactory.load(path, use_sections=use_sections)
